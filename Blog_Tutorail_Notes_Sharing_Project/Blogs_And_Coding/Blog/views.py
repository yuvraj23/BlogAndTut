...
from django.contrib.auth.decorators import login_required
from Blog.models import BlogPost,RequestForCode,ProblemStatement,Comment_Related_To_Problem,OffCampusRecruitment
from django.core.paginator import Paginator,PageNotAnInteger,EmptyPage
from Blog.forms import CommentForm,Comment_Related_To_ProblemForm,SignUpForm
...
def dashboard(request,year,month,day,post,lk=0,dis=0):
    post=get_object_or_404(BlogPost,slug=post,status='published',publish__year=year,
